...
# The key needs to be used when retrieving the data for a hash and it needs to be compared with the value
# in this case the "dogs" and 2 needed to be switched in line 17