...
puts input_percent.to_i >= 90       # The input_percent variable needs to be converted into an integer 
                                    # and the operator needs to be changed to >= so a score of 90 is included
